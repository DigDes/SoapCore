...
namespace SoapCore.Tests.Wsdl
{
	...
	public class WsdlTests
	{
		...
		private async Task<string> GetWsdlFromMetaBodyWriter<T>(SoapSerializer serializer)
		{
			...
			var encoder = new SoapMessageEncoder(MessageVersion.Soap12WSAddressingAugust2004, System.Text.Encoding.UTF8, XmlDictionaryReaderQuotas.Max, false, true, false, null);
